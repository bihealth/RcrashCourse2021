 ...
 * What regular expression matches all of the ankyrin repeat genes (but not other genes) in the following vector: `c("ANKRD22", "ank.rep.domain 12", "ifng-1", "ANKRD-33", "  ankrd23", "MAPK)`
