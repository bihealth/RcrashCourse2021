...
* Coming back to writing your own functions
...
---------------------------- ------------------------------- --------------------------
Columns separated by spaces  `read_table()`                  one or more
                                                             spaces separate 
                                                             each column

TSV / TAB separated values   `read_tsv()`                    Delimiter is tab (`\t`).

CSV / comma separated        `read_csv()`                    Comma separated values
                                                             
Any delimiter                `read_delim()`                  Customizable
